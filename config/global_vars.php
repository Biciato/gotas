...
Configure::write(
    [
        ...
        'documentReceiptPath' => 'img/recibos/documentos/',
        'documentReceiptPathRead' => '/img/recibos/documentos/',
        'documentReceiptPathShellRead' => 'img\\recibos\\documentos\\',
        'imageReceiptPathTemporary' => 'img/tmp/recibos/',
        'imageGiftPath' => 'img/brindes/imagens/',
        'imageGiftPathRead' => '/img/brindes/imagens/',
        'imageGiftPathTemp' => 'img/tmp/brindes/imagens/',
        'imageGiftPathReadTemp' => '/img/tmp/brindes/imagens/',
        'imageNetworkPath' => 'img/redes/imagens/',
