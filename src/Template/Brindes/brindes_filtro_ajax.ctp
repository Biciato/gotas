...
$mostrarCheckboxDesconto = !empty($mostrarCheckboxDesconto) ? $mostrarCheckboxDesconto : false;
?>
<div class="gifts-query-region">
    <h4>Selecione um brinde</h4>

    <?php if ($mostrarCheckboxDesconto): ?>
    <label for="habilita_brindes_desconto">Complemento em Dinheiro</label>
    <input type="checkbox"
        value="1"
        name="habilita_brindes_desconto"
        id="habilita-brindes-desconto"
        class="habilita-brindes-desconto"
        ...
        <div class="form-group row">
            ...
            <?php if ($compraGotas) : ?>
                <div class="col-lg-2">
                    ...
                    <input type="password" class="current_password form-control" required id="current_password" />
