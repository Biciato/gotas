...
/**
  ...
  * @file     src/Template/Gotas/gotas_input_form_com_ocr.ctp
  * @date     13/09/2017
  */
...
?>
    ...
    <div class="col-lg-9 gotas-instascan-manual-insert">
        <div class="col-lg-12">
            <h4 class="col-lg-11">
        ...
        <p>
            <span>Como não foi possível realizar a importação automática pelo site da SEFAZ, será necessário informar manualmente. Informe cada compra conforme a nota fiscal.</span>
            <br />
        ...
        <div>
            ...
            <div class="col-lg-6">
                ...
                <button class="btn btn-default add-parameter">
                    <span class="fa fa-plus-circle"> Adicionar</span>
                </button>
                    ...
                    <table class="table table-hover table-responsive gotas-products-table">
                        <thead>
                            <tr>
                                ...
                                <td class="row">Quantidade</td>
                                <td class="row">Ações</td>
                            </tr>
                        </thead>
                        <tbody>
