...
<script src="/webroot/js/scripts/gotas/importacao_gotas_sefaz<?= $extensionDebug ?>.js?version=<?= SYSTEM_VERSION ?>"></script>

<link rel="stylesheet" href="/webroot/css/styles/gotas/importacao_gotas_sefaz<?= $extensionDebug ?>.css?version=<?= SYSTEM_VERSION ?>" />
