 ...
 * @filename rtibrindes/src/Template/PontuacoesComprovantes/relatorio_pontuacoes_comprovantes_usuarios_redes.ctp
...
$title = "Relatório de Comprovantes das Pontuações de Usuários por Redes";
...
<div class="col-lg-9 col-md-8 ">
    ...
    <?= $this->element('../PontuacoesComprovantes/filtro_relatorio_pontuacoes_comprovantes_usuarios_redes', [
