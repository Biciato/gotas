...
$minLength = ($usuario->tipo_perfil == (int) Configure::read('profileTypes')['UserProfileType']) ? 6 : 8;
?>
    ...
    <fieldset>
        ...
        <?php if ($id == $usuarioLogado->id) : ?>
            <div class="form-group">
                ...
                <?php else : ?>
                    <input type="password" id="senha_antiga" name="senha_antiga" class="form-control" minLength="<?= $minLength ?>" require />
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php else : ?>
                    <input type="password" id="senha" name="senha" class="form-control" minLength="<?= $minLength ?>" require />
                <?php endif; ?>
            </div>
            ...
            <div class="form-group">
                ...
                <?php else : ?>
                    <input type="password" id="confirm_senha" name="confirm_senha" class="form-control" minLength="<?= $minLength ?>" require />
                <?php endif; ?>
            </div>
