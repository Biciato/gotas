<div class="middle-box text-center loginscreen animated fadeInDown">
    <div>
        ...
        <form class="m-t" role="form" action="javascript:void(0)" id="login-form">
            ...
            <button type="submit" class="btn btn-info block full-width m-b" id="btn-login">Login</button>
            ...
            <a class="btn btn-white btn-block" href="<?php echo $this->Url->build(['controller' => 'usuarios', 'action' => 'registrar']) ?>"><?php echo __('Criar uma conta'); ?></a>
        </form>
