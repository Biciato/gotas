 ...
 * @file     src/Template/Usuarios/filtro_usuarios_venda_avulsa_ajax.ctp
 * @date     23/08/2018
 */
...
<?php if (Configure::read('debug') == true) : ?>
    <?= $this->Html->script('scripts/usuarios/filtro_usuarios_venda_avulsa_ajax') ?>
    <?= $this->Html->css('styles/usuarios/filtro_usuarios_venda_avulsa_ajax') ?>
<?php else : ?>
    <?= $this->Html->script('scripts/usuarios/filtro_usuarios_venda_avulsa_ajax.min') ?>
    <?= $this->Html->css('styles/usuarios/filtro_usuarios_venda_avulsa_ajax.min') ?>
<?php endif; ?>
