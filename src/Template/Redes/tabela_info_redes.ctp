...
<div class="form-group row">
    ...
    <div class="col-lg-4">
        ...
        <input name="quantidade_consumo_usuarios_dia"
            id="quantidade_consumo_usuarios_dia"
            class="form-control"
            value="<?php echo $rede['quantidade_consumo_usuarios_dia'] ?>"
            disabled
        />
    </div>
</div>
<div class="form-group row">
    <div class="col-lg-3">
        ...
        <input name="custo_referencia_gotas"
            ...
            class="form-control"
            value="<?php echo $this->Number->currency($rede['custo_referencia_gotas']) ?>"
            disabled
        />
    </div>
