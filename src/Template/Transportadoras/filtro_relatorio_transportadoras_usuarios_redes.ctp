...
<?php if (Configure::read('debug') == true) : ?>
    <?= $this->Html->script('scripts/transportadoras/filtro_relatorio_transportadoras_usuarios_redes') ?>
<?php else : ?>
    <?= $this->Html->script('scripts/transportadoras/filtro_relatorio_transportadoras_usuarios_redes.min') ?>
<?php endif; ?>
