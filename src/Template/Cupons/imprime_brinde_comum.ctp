...
$this->Breadcrumbs->add('Confirmar Brinde e Quantidade para Resgate', ['controller' => 'ClientesHasBrindesHabilitados', 'action' => 'resgatar_brinde', $clientes_has_brindes_habilitados_id]);
