...
<?php foreach ($pontuacoes_comprovantes as $key => $pontuacao) : ?>
	...
	<a href="<?= $pontuacao['appAddress'].'pontuacoes/detalhesCupom/'. $pontuacao['id']?>">Navegar para auditoria</a>
    ...
    <table class="table table-striped table-hover align-center">
        ...
        <tr>
            ...
            <td>
                <?= h($this->Number->precision($pontuacao['soma_pontuacoes'], 2)) ?></td>
            </td>
        </tr>
        <tr>
            <th>
    ...
    <div class="container">
        <div class="left">
            ...
            <?= $this->Html->image('cid:'.$pontuacao['image_data'], ['alt' => 'Comprovante', 'Title' => "Comprovante", 'class' => 'image-receipt', 'width' => '360', 'height' => '683', 'style' => 'display: block;']) ?>
        ...
        <div class="right">
            ...
            <?= $this->element('../Pontuacoes/tabela_descritivo_pontuacoes', 
            [
                'pontos' => $pontuacao['pontuacoes'],
                'show_actions' => false
            ]) ?>
        </div>
    </div>
