 ...
 * @file: \src\Template\Element\modal_invalidate.ctp
 * @date: 28/09/2017
 *
 * --------------------------------------------------------------------------------
 * Version list:
...
?>
    ...
    <div id="modal-invalidate" class="modal fade modal-invalidate" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="modal-body-content">Deseja invalidar o registro?</p>
                </div>
                <div class="modal-footer">
                    <!-- Form para alterar a url de destino -->
                    <form method="post" name="post-invalidate"></form>
                    <?= $this->Html->tag('div',
                    'Confirmar',
                    [
