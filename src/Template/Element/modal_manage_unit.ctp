 ...
 * @file: \src\Template\Element\modal_manage_unit.ctp
 * @date: 28/09/2017
 *
 * --------------------------------------------------------------------------------
 * Version list:
 ...
 */
  ...
  *      '#',
  *      array(
  *         'class'=>'btn btn-danger btn-manage-unit',
  *         'data-toggle'=> 'modal',
  *         'data-target' => '#modal-manage-unit',
  *         'data-action'=> Router::url(
  *            array('action'=>'manage-unit',$id)
  *         ),
  *         'escape' => false),
  *  false);
  */
...
?>
    ...
    <div id="modal-manage-unit" class="modal fade modal-manage-unit" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="modal-body-content">Deseja gerenciar unidade selecionada?</p>
                </div>
                <div class="modal-footer">
                    <!-- Form para alterar a url de destino -->
                    <form method="post" name="post-manage-unit-entire-network"></form>
