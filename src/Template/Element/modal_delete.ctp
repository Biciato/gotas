 ...
 * @file: \src\Template\Element\modal_delete.ctp
 * @date: 28/09/2017
 *
 * --------------------------------------------------------------------------------
 * Version list:
...
?>
    ...
    <div id="modal-delete" class="modal fade modal-delete" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="modal-body-content">Deseja apagar o registro?</p>
                </div>
                <div class="modal-footer">
                    <!-- Form para alterar a url de destino -->
                    <form method="post" name="post-delete"></form>
                    <?= $this->Html->tag('div',
                        'Confirmar',
                        [
