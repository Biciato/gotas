 ...
 * @file: \src\Template\Element\modal-confirm-purchase-with-message.ctp
 * @date: 28/01/2018
 *
 * --------------------------------------------------------------------------------
 * Version list:
...
?>
    ...
    <div id="modal-confirm-purchase-with-message" class="modal fade modal-confirm-purchase-with-message" role="dialog">
