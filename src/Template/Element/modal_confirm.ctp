 ...
 * @file: \src\Template\Element\modal_confirm.ctp
 * @date: 28/09/2017
 *
 * --------------------------------------------------------------------------------
 * Version list:
...
?>
    ...
    <div id="modal-confirm" class="modal fade modal-confirm" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="modal-body-content">Deseja confirmar a ação sobre o registro?</p>
                </div>
                <div class="modal-footer">
                    <!-- Form para alterar a url de destino -->
                    <form method="post" name="post-confirm-entire-network"></form>
