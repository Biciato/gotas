...
$this->Breadcrumbs->add('Gênero de Brindes Habilitados', ['controller' => 'tipos_brindes_clientes', "action" => "tipos_brindes_cliente", $cliente->id]);
...
<div class="tiposBrindesClientes form col-lg-9 col-md-8 columns content">
    ...
    <fieldset>
        ...
        <?= $this->element("../TiposBrindesClientes/form_tipos_brindes_cliente", ["selectTiposBrindesEnabled" => true]) ?>
    </fieldset>
    <?= $this->Form->end() ?>
</div>
