<div class="form-group row border-bottom white-bg page-heading">
    ...
    <div class="col-lg-8">
        <div class="title-action">
            <a href="#" class="btn btn-primary" tooltip="Salvar" id="redes-new-btn-show" >
                ...
                <div class="ibox-content">
                    <form name="form_redes_add" id="form-redes-add">
                        <ul class="nav nav-tabs">
                            ...
                            <li>
                                <a href="#redes-image" data-toggle="tab"
                                    >Imagem</a
                                >
                            </li>
                            <li>
                                <a href="#common-options" data-toggle="tab"
                                    >Opções</a
                                >
                            </li>
                            <li>
                                <a href="#api-options" data-toggle="tab"
                                    >Serviços Mobile / API</a
                                >
                            </li>
                        </ul>
                            ...
                            <div class="tab-pane active" id="general">
                                <div class="ibox-content">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            <label
                                                for="quantidade_pontuacoes_usuarios_dia"
                                                >Máx. Abast. Gotas Diárias p/
                                                Usuário*</label
                                            >
                                            <input
                                                type="number"
                                                ...
                                                title="Máximo Abastecimento Gotas Diárias para Usuário"
                                                required
                                                value="3"
                                            />
                                        </div>
                                        <div class="col-lg-3">
                                            <label
                                                for="quantidade_consumo_usuarios_dia"
                                                >Máximo de Compras Diárias p/
                                                Usuário*</label
                                            >
                                            <input
                                                type="text"
                                                ...
                                                title="Máximo de Compras Diárias para Usuário"
                                                class="form-control"
                                        ...
                                        <div class="col-lg-3">
                                            <label
                                                for="qte_mesmo_brinde_resgate_dia"
                                                >Máximo Resgates Mesmo Brinde /
                                                Dia*</label
                                            >
                                            <input
                                                type="text"
                                                ...
                                                class="form-control"
                                                name="qte_mesmo_brinde_resgate_dia"
                                                required
                                                value=""
                                            />
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-4">
                                            <label
                                                for="tempo_expiracao_gotas_usuarios"
                                                >Tempo Expiracao de Pontos dos
                                        ...
                                        <div class="col-lg-4">
                                            <label for="custo_referencia_gotas"
                                                >Custo Referência Gotas
                                                (R$)*</label
                                            >
                                            <input
                                                type="text"
                                        ...
                                        <div class="col-lg-4">
                                            <label
                                                for="media_assiduidade_clientes"
                                                >Média Assid. Clientes
                                                (Mês)*</label
                                            >
                                            <input
                                                type="number"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            <label
                                                for="qte_gotas_minima_bonificacao"
                                                >Qte. Litros Mínima para Atingir
                                                Bonificação</label
                                            >
                                            <input
                                                type="number"
                                                name="qte_gotas_minima_bonificacao"
                                        ...
                                        <div class="col-lg-6">
                                            <label for="qte_gotas_bonificacao"
                                                >Qte. Bonificação na Importação
                                                da SEFAZ</label
                                            >
                                            <input
                                                type="number"
                                                name="qte_gotas_bonificacao"
                                                required="required"
                                                id="qte_gotas_bonificacao"
                                                class="form-control"
                                                value=""
                                ...
                                <div class="ibox-content">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="hidden">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-2">
                                                    <?= $this->Form->input('crop-height',
                                                    ['type' => 'text', 'label'
                                                    => 'crop height', 'id' =>
                                                    'crop-height', 'readonly' =>
                                                    true]); ?>
                                                </div>
                                                <div class="col-lg-2">
                                                    <?= $this->Form->input('crop-width',
                                                    ['type' => 'text', 'label'
                                                    => 'crop width', 'id' =>
                                                    'crop-width', 'readonly' =>
                                                    true]); ?>
                            ...
                            <div class="tab-pane" id="api-options">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        ...
                                        <label for="app_personalizado">
                                            <input
                                                type="checkbox"
                                                <?="$rede-"
                                            />app_personalizado ? 'checked' : ''
                                            ?> id="app_personalizado"
                                            name="app_personalizado"
                                    ...
                                    <div class="col-lg-12">
                                        <input
                                            type="hidden"
                                            name="msg_distancia_compra_brinde"
                                            value="0"
                                        />
                                        <label
                                            for="msg_distancia_compra_brinde"
                                        >
                                            <input
                                                type="checkbox"
                                                <?="$rede-"
                                            />msg_distancia_compra_brinde ?
                                            'checked' : '' ?>
                                            id="msg_distancia_compra_brinde"
                                            name="msg_distancia_compra_brinde"
                                            class="items_app_personalizado"
                                            value="1"> Exibir Mensagem de
                                            Distância ao Comprar
                                        </label>
                                    </div>
                                    <div class="col-lg-12">
                                        <input
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-12">
                                        <input
                                            type="hidden"
                                            name="pontuacao_extra_produto_generico"
                                            value="0"
                                        />
                                        <label
                                            for="pontuacao_extra_produto_generico"
                                        >
                                            <input
                                                type="checkbox"
                                                <?="$rede-"
                                            ...
                                            'checked' : '' ?>
                                            id="pontuacao_extra_produto_generico"
                                            name="pontuacao_extra_produto_generico"
                                            value="1" title="Adiciona
