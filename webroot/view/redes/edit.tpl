                        ...
                        <div class="tab-content clearfix">
                                ...
                                <div class="ibox-content">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="number" placeholder="Máx. Abast. Gotas Diárias p/ Usuário..."
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="text" name="custo_referencia_gotas" id="custo-referencia-gotas"
                                                ...
                                                title="Custo Referência Gotas (R$)" class="form-control" />
                                        </div>
                                        ...
                                        <div class="col-lg-4">
                                            ...
                                            <input type="number" name="media_assiduidade_clientes"
                                                title="Média Assiduidade Clientes (Mês)" id="media-assiduidade-clientes"
                                                class="form-control"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-6">
                                            ...
                                            <input type="number" name="qte_gotas_minima_bonificacao"
                                                ...
                                                title="Qte. Litros Mínima para Atingir Bonificação" value=""
                                                class="form-control" />
                                        </div>
                            ...
                            <div class="tab-pane" id="redes-image">
                                <div class="ibox-content">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-lg-12">
                                            <label for="nome-img">Logotipo da Rede* (Ícone na lista de Estabelecimentos
                                                da API)</label>
                                    ...
                                    <div class="form-group row">
                                        <div class="img-crop-container">
                                            <div class="col-lg-12">
                                                ...
                                                <img src="" id="img-crop" class="img-crop-logo" name="img_crop"
                                                    title="Ícone na lista de Estabelecimentos da API" />
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div>
                                            <div class="col-lg-12">
                                                ...
                                                <div id="img-crop-preview" class="img-crop-logo-preview" name="teste">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<link rel="stylesheet" href="/webroot/css/styles/redes/edit.css">
<script>
    $(document).ready(function () {
        let dataStorage = JSON.parse(localStorage.getItem("data"));

        redesEdit.init(dataStorage.id);
    })
