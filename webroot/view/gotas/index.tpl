<div class="form-group row border-bottom white-bg page-heading">
    <div class="col-lg-4">
        <h2>Atribuição de Gotas de Por Consumo da Rede</h2>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#/">Início</a></li>
            <li class="breadcrumb-item active"><strong>Gotas</strong></li>
        </ol>
    </div>
    <div class="col-lg-8">
        <div class="title-action">
            <a href="#/gotas/add" class="btn btn-primary" tooltip="Salvar" id="redes-new-btn-show"> <i class="fas fa-plus"></i> Novo</a>
        </div>
    </div>
</div>
<div class="content">
    <div class="row gotas-index">
        <div class="col-lg-12">
            <div class="ibox">
                ...
                <div class="ibox-content">
                    <div id="filter-coupons" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <form action="javascript:void(0)" id="filtro_unidades_form">
                                <div class="form-group row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="form-group ">
                                            <label for="unidades_filtro">Filtrar por unidade</label>
                                            <select id="unidades_filtro" name="unidades_filtro" class="form-control col-lg-2">
                                            </select>
                                        </div>
                                    </div>
                                     <div class="col-lg-6 col-md-6">
                                        <div class="form-group ">
                                            <button type="text" class="btn btn-info" id="filtrar_usuarios" style="margin-top: 1.9em">
            ...
            <div class="ibox">
                <div class="ibox-title">Gotas</div>
                <div class="ibox-content">
