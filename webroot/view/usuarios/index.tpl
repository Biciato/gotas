<div class="form-group">
    ...
    <div class="panel-group">
        <div class="panel panel-default">
            <div class="panel-heading panel-heading-sm text-center" data-toggle="collapse" href="#collapse1" data-target="#filter-users">
            ...
            <div id="filter-users" class="panel-collapse collapse in">
...
<div class="row">
    <div class="col-lg-12">
        ...
        <div id="modal-visualize" class="modal fade" role="dialog">
            <div class="modal-dialog modal-lg">

                <div class="modal-content">
                    <div class="modal-header ">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h3 class="modal-title success-message"><span class="modal-title-content">Dados do usuário</span></h4>
                    </div>
                    <div class="modal-body" id="modal-visualize-body">
                    </div>
                    <div class="modal-footer">
                        <div class="btn btn-default" data-dismiss="modal">Ok!</div>
                    </div>
                </div>
