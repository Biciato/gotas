...
$(document).ready(function() {
    ...
    // $(".gotas-camera-manual-insert #quantidade_input").maskMoney("mask", 9999.999);
    ...
    $(".gotas-camera-manual-insert .call-modal-how-it-works").on(
        "click",
        function() {
    ...
    var enableSelectParameter = function() {
        if ($(".gotas-camera-manual-insert #list_parametros").val() !== "") {
            $(".gotas-camera-manual-insert .select-parameter").prop(
                "disabled",
                false
            );
        } else {
    ...
    $(".gotas-camera-manual-insert #list_parametros").on("change", function() {
        ...
        parameter == undefined
            ? $(".gotas-camera-manual-insert #quantidade_input").prop(
                  "disabled",
                  true
              )
            : $(".gotas-camera-manual-insert #quantidade_input").prop(
     ...
     */
    $(".gotas-camera-manual-insert .user-btn-proceed-picture-mg").on(
        "click",
        function() {
