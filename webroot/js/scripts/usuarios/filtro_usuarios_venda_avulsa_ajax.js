 ...
 * @file webroot\js\scripts\usuarios\filtro_usuarios_venda_avulsa_ajax.js
 * @date 23/08/2018
 *
 */
...
$(document).ready(function () {
    ...
    var searchUsuario = function () {
        ...
        if (data.parametro.length <= 3) {
            ...
            $.ajax({
                url: '/api/usuarios/find_usuarios',
                type: 'POST',
                ...
                beforeSend: function (xhr) {
                    ...
                    // xhr.setRequestHeader("IsMobile", true);
                    // xhr.setRequestHeader("Authorization", "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6Niwic3ViIjo2LCJleHAiOjE1MzU2MDE2NTJ9.Mc99hBZFYoM0aQH3Ae-u9npg-snxL8Ih42AmY5WBeQ0");
                },
                error: function (e) {
                    console.log(e);
                    closeLoaderAnimation();
