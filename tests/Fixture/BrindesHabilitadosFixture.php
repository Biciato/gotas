...
/**
 * BrindesHabilitadosFixture
 *
 */
class BrindesHabilitadosFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'brindes_habilitados_id_idx' => ['type' => 'index', 'columns' => ['id'], 'length' => []],
            'brindes_habilitados_brindes_id_idx' => ['type' => 'index', 'columns' => ['brindes_id', 'id'], 'length' => []],
        ],
        '_constraints' => [
